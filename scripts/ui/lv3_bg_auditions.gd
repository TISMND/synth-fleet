...
const SLIDER_DEFS: Array[Dictionary] = [
	...
	{"key": "grid_spacing_x", "label": "GRID SPACING X", "min": 40.0, "max": 250.0, "default": 110.0, "step": 1.0},
	...
	{"key": "light_ambient", "label": "AMBIENT LEVEL", "min": 0.0, "max": 1.0, "default": 0.5, "step": 0.02},
	...
	{"key": "pulse_intensity", "label": "PULSE INTENSITY", "min": 0.0, "max": 1.0, "default": 0.38, "step": 0.02},
	{"key": "pulse_hdr", "label": "PULSE HDR", "min": 1.0, "max": 20.0, "default": 9.2, "step": 0.1},
	{"key": "pulse_speed", "label": "PULSE SPEED", "min": 0.0, "max": 5.0, "default": 1.3, "step": 0.1},
	{"key": "pulse_scale", "label": "PULSE SCALE", "min": 0.1, "max": 8.0, "default": 7.1, "step": 0.1},
	{"key": "pulse_threshold", "label": "PULSE DEAD SPACE", "min": 0.0, "max": 1.0, "default": 0.22, "step": 0.02},
