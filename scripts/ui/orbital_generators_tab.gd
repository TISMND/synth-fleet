...
var _orbiter_fade_in_slider: HSlider
var _orbiter_fade_in_label: Label
var _orbiter_fade_out_slider: HSlider
var _orbiter_fade_out_label: Label
...
func _build_visual_tab() -> Control:
	...
	_orbiter_fade_in_slider = fi_row[0]
	_orbiter_fade_in_label = fi_row[1]

	var fo_row: Array = _add_slider_row(form, "Fade Out (s):", 0.0, 2.0, 0.3, 0.05)
	_orbiter_fade_out_slider = fo_row[0]
	_orbiter_fade_out_label = fo_row[1]

	# Update orbiter preview fade durations when sliders change
	_orbiter_fade_in_slider.value_changed.connect(func(_v: float) -> void:
		if _preview_orbiter_renderer:
			_preview_orbiter_renderer.set_fade_durations(_orbiter_fade_in_slider.value, _orbiter_fade_out_slider.value)
	)
	_orbiter_fade_out_slider.value_changed.connect(func(_v: float) -> void:
		if _preview_orbiter_renderer:
			_preview_orbiter_renderer.set_fade_durations(_orbiter_fade_in_slider.value, _orbiter_fade_out_slider.value)
	)
...
func _collect_visual_data(data: Dictionary) -> void:
	...
	data["fade_in_duration"] = _orbiter_fade_in_slider.value
	data["fade_out_duration"] = _orbiter_fade_out_slider.value
...
func _populate_visual_fields(device: DeviceData) -> void:
	...
	_orbiter_fade_in_slider.value = device.fade_in_duration
	_orbiter_fade_out_slider.value = device.fade_out_duration
...
func _reset_visual_defaults() -> void:
	...
	_orbiter_fade_in_slider.value = 0.3
	_orbiter_fade_out_slider.value = 0.3
